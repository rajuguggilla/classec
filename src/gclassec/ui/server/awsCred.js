...
// var server = require("ipadd.js");

exports.postAws = function(req, res) {
    ...
    var data = querystring.stringify({
                     accessKeyID: req.body.aws.accessKeyID,
                     accessKeyValue: req.body.aws.accessKeyValue
                     });

    var options = {
        host: "110.110.110.233",
        port: 4567,
        path: '/aws/updatecredentials',
        method: 'POST',
        headers: {
